...
public class MusicMenuDetailDao extends AbstractDao<MusicMenuDetail, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property MenuCreateTime = new Property(7, java.util.Date.class, "MenuCreateTime", false, "MENU_CREATE_TIME");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MUSIC_MENU_DETAIL' (" + //
                ...
                "'MENU_CREATE_TIME' INTEGER);"); // 7: MenuCreateTime
    }
    ...
    protected void bindValues(SQLiteStatement stmt, MusicMenuDetail entity) {
        ...
        java.util.Date MenuCreateTime = entity.getMenuCreateTime();
        if (MenuCreateTime != null) {
            stmt.bindLong(8, MenuCreateTime.getTime());
        }
    }
    ...
    public MusicMenuDetail readEntity(Cursor cursor, int offset) {
        MusicMenuDetail entity = new MusicMenuDetail( //
            ...
            cursor.isNull(offset + 7) ? null : new java.util.Date(cursor.getLong(offset + 7)) // MenuCreateTime
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, MusicMenuDetail entity, int offset) {
        ...
        entity.setMenuCreateTime(cursor.isNull(offset + 7) ? null : new java.util.Date(cursor.getLong(offset + 7)));
     }
